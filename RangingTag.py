...
class RangingTag:
    ...
    def transmitRange(self):
        ...
        self.data[1] = 0xAB
        self.data[2] = 0xCD
        self.timeRangeSentTS = self.dw1000_device.setDelay(
            self.REPLY_DELAY_TIME_US, C.MICROSECONDS
        )
...
try:
    ...
    rangingTag.dw1000_device.generalConfiguration(
        "7D:00:22:EA:82:60:3B:9C", C.MODE_LONGDATA_RANGE_ACCURACY
    )
    rangingTag.dw1000_device.registerCallback("handleSent", rangingTag.handleSent)
    rangingTag.dw1000_device.registerCallback(
        "handleReceived", rangingTag.handleReceived
    )
